...
{
    public class UpdateInternalMerchantTierRequestModelValidator :  AbstractValidator<CreateInternalMerchantTierRequestModel>
    {
        public UpdateInternalMerchantTierRequestModelValidator()
        {
